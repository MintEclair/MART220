...
//evil cookie that wants to MURDER SANTA
var evilCookieRandomX;
var evilCookieRandomY;
var objectOfEvilCookie;
...
function preload()
{
  ...
  goodsound = loadSound('../sounds/hohoho.mp3')
  badsound = loadSound('../sounds/loser.mp3')
}
...
function setup()
    {
        ...
        evilCookieRandomX = random(10, 500)
        evilCookieRandomY = random(10,500)
        ...
        objectOfEvilCookie = new cookie("images/evilcookie.png", evilCookieRandomX, evilCookieRandomY, 101, 100)
...
function draw(){
        ...
        if(objectOfEvilCookie != null){
          objectOfEvilCookie.draw();
        }
      ...
      console.log(key);
          ...
          for (var ii = 0; ii < idleArray.length; ii++) {
              ...
              if (objectOfEvilCookie != null) {
                if(walkArray[ii].checkCollision(objectOfEvilCookie.x, objectOfEvilCookie.y, objectOfEvilCookie.w, objectOfEvilCookie.h)) {
                  objectOfEvilCookie = null;
                  score--;
                  badsound.play();
                }
              }
...
function timer()
{
  ...
  function createNewEvilCookie(){
    objectOfEvilCookie = new cookie("images/evilcookie.png", random(10, width-100), random(10, height-100), 101, 100)
  }
